...
export function Header(item) {
    ...
    let img = importAll(require.context(`./../../BackEnd/php/images/tat_ca_san_pham/`, true, /\.(png|webp|svg|jpg)$/));
    ...
    const getImgFavourite = (img: string[]) => {
        let result = [];
    ...
    imageFavorite = getImgFavourite(img);
    imageStore = getImgStore(img);
    useEffect(() => {
